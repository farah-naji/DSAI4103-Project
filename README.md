...
| Dataset | Source | Size |
- listings.csv : [Maven Analytics / Inside Airbnb](http://insideairbnb.com/get-the-data) | 279,712 rows, 10 cities |
- reviews.csv:  [Maven Analytics / Inside Airbnb](http://insideairbnb.com/get-the-data) 
